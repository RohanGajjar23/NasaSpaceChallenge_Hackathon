              ...
              children: [
                Container(
                  ...
                  child: onRegisterPage
                      ? RegsiterPage(
                          fontSize: fontSize, size: MediaQuery.of(context).size)
                      : LoginPage(
                          fontSize: fontSize,
                ...
                InkWell(
                  onTap: () {
                    setState(() {
                      ...
                      // print("before ${FocusScope.of(context).hasFocus}");
                      FocusScope.of(context).unfocus();
                      // print("After ${FocusScope.of(context).hasFocus}");
                      // print("Temo $onRegisterPage");
                    });
                  },
                  child: Container(
                    width: size.width / 4,
